    ...
    public partial class RequestClosure : SecurePage {
        ...
        public static object GetMyLocations() {
            try {
                ...
                AppLogger.Error("RequestClosure.GetMyLocations", ex);
        ...
        public static object GetManagerForLocation(int locationId) {
            try {
                ...
                AppLogger.Error("RequestClosure.GetManagerForLocation", ex);
                return new { success = false, message = ex.Message };
            }
        }
        ...
        public static object SubmitRequest(int locationId, string notes) {
            try {
                ...
                AppLogger.Error("RequestClosure.SubmitRequest", ex);
                return new { success = false, message = ex.Message };
            }
        }
        ...
        // ============================================================
        // GET MY HISTORY
        // Historial de solicitudes del usuario en la guardia activa.
        // Solo muestra registros de la guardia actual para evitar
        // mezclar eventos de guardias anteriores.
        // ============================================================
        [WebMethod(EnableSession = true)]
        public static object GetMyHistory() {
            try {
                ...
                AppLogger.Error("RequestClosure.GetMyHistory", ex);
                return new { success = false, message = ex.Message };
            }
        }
    }
