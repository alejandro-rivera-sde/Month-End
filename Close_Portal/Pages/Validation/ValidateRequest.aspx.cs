    ...
    public partial class ValidateRequest : SecurePage {
        ...
        public static object GetRequests() {
            try {
                ...
                AppLogger.Error("ValidateRequest.GetRequests", ex);
        ...
        public static object ReviewRequest(int requestId, string action, string reviewNotes) {
            try {
                ...
                AppLogger.Error("ValidateRequest.ReviewRequest", ex);
                return new { success = false, message = ex.Message };
            }
        }
        // ============================================================
        ...
        public static object GetClosedRequests() {
            try {
                ...
                AppLogger.Error("ValidateRequest.GetClosedRequests", ex);
                return new { success = false, message = ex.Message };
            }
        }
        ...
        public static object RevertLocation(int requestId, string reason) {
            try {
                ...
                using (var conn = new SqlConnection(_connStr)) {
                    ...
                    LocationHub.NotifyManagersLocationReverted(locationId, locationName, callerName);
                    Services.EmailService.NotifyLocationReverted(locationId, locationName, callerName);
                }

                return new { success = true, message = "Locación revertida a operación correctamente." };
            } catch (Exception ex) {
                AppLogger.Error("ValidateRequest.RevertLocation", ex);
                return new { success = false, message = ex.Message };
            }
        }
        // ============================================================
        ...
        private static int GetActiveGuardId() {
            try {
                ...
                AppLogger.Error("ValidateRequest.GetActiveGuardId", ex);
                return 0;
            }
        }
    }
