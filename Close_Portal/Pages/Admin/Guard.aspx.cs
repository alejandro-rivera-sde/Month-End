    ...
    public partial class Guard : SecurePage {
        ...
        public static object GetDepartments() {
            try {
                ...
                AppLogger.Error("Guard.GetDepartments", ex);
        ...
        public static object GetUsersByDepartment(int departmentId) {
            try {
                ...
                AppLogger.Error("Guard.GetUsersByDepartment", ex);
                return new { success = false, message = ex.Message };
            }
        }
        ...
        public static object GetGuardStatus() {
            try {
                ...
                AppLogger.Error("Guard.GetGuardStatus", ex);
                return new { success = false, message = ex.Message };
            }
        }
        ...
        public static object GetActiveGuardLocations() {
            try {
                ...
                AppLogger.Error("Guard.GetActiveGuardLocations", ex);
                return new { success = false, message = ex.Message };
            }
        }
        ...
        public static object GetGuardHistory() {
            try {
                ...
                AppLogger.Error("Guard.GetGuardHistory", ex);
                return new { success = false, message = ex.Message };
            }
        }
        ...
        public static object GetAllActiveLocations() {
            try {
                ...
                AppLogger.Error("Guard.GetAllActiveLocations", ex);
                return new { success = false, message = ex.Message };
            }
        }
        ...
        public static object ReserveDates(string startTime, string estimatedEndTime) {
            try {
                ...
                AppLogger.Error("Guard.ReserveDates", ex);
                return new { success = false, message = ex.Message };
            }
        }
        ...
        public static object SaveGuardLocations(int guardId, int[] locationIds) {
            try {
                ...
                if (roleId < RoleLevel.Owner) {
                    ...
                    if (!string.Equals(deptCode, "AR", StringComparison.OrdinalIgnoreCase))
                        return new { success = false, message = "Solo el departamento AR puede modificar las locaciones de la guardia." };
                }
                ...
                AppLogger.Error("Guard.SaveGuardLocations", ex);
                return new { success = false, message = ex.Message };
            }
        }
        ...
        public static object ConfirmGuard(int guardId) {
            try {
                ...
                AppLogger.Error("Guard.ConfirmGuard", ex);
                return new { success = false, message = ex.Message };
            }
        }
        ...
        public static object CloseGuard(int guardId) {
            try {
                ...
                var da = new GuardDataAccess();
                DateTime? guardStart = da.GetGuardStartTime(guardId);
                var result = da.CloseGuard(guardId);

                if (result.Success && guardStart.HasValue) {
                    ProcessesService.TriggerConfirmacionCierre(guardStart.Value);
                    LocationHub.NotifyGuardClosed(guardId);
                    string callerEmail = HttpContext.Current.Session["Email"]?.ToString();
                    EmailService.NotifyGuardClosed(DateTime.Now, callerEmail);
                }
                ...
                AppLogger.Error("Guard.CloseGuard", ex);
                return new { success = false, message = ex.Message };
            }
        }
        ...
        public static object AssignSpot(int spotId, int userId) {
            try {
                ...
                AppLogger.Error("Guard.AssignSpot", ex);
                return new { success = false, message = ex.Message };
            }
        }
        ...
        public static object UnassignSpot(int spotId) {
            try {
                ...
                AppLogger.Error("Guard.UnassignSpot", ex);
                return new { success = false, message = ex.Message };
            }
        }
        ...
        public static object RemoveGuard(int guardId) {
            try {
                ...
                if (roleId < RoleLevel.Owner) {
                    string deptCode = new GuardDataAccess().GetUserDepartmentCode(userId);
                    if (!string.Equals(deptCode, "AR", StringComparison.OrdinalIgnoreCase))
                        return new { success = false, message = "Solo el departamento AR puede eliminar guardias." };
                }
                ...
                AppLogger.Error("Guard.RemoveGuard", ex);
                return new { success = false, message = ex.Message };
            }
        }
