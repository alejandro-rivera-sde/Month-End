            ...
            <div id="gdClosurePanel" class="gd-step-panel">
                ...
                <div class="gd-closure-checklist">
                    <label class="gd-closure-check-item">
                        ...
                        <span><span data-translate-key="gd.check.operations">Operaciones</span> <strong>AR</strong> <span data-translate-key="gd.check.finished">finalizadas</span></span>
                    </label>
                    <label class="gd-closure-check-item">
                        <input type="checkbox" id="gdCheckCS" onchange="gdUpdateCloseBtn()" />
                        <span class="material-icons gd-closure-icon">local_shipping</span>
                        <span><span data-translate-key="gd.check.operations">Operaciones</span> <strong>CS</strong> <span data-translate-key="gd.check.finished">finalizadas</span></span>
                    </label>
                </div>
