                        ...
                        <div id="newUserFields" style="display:none">
                            <div class="um-general-grid">
                                ...
                                <div class="field-group">
                                    ...
                                    <input type="text" id="newFirstName" data-translate-key="um.modal.first_name" placeholder="Nombre" maxlength="50" autocomplete="off" />
                                </div>
                                <div class="field-group">
                                    <label for="newLastName" data-translate-key="um.modal.last_name">Apellido</label>
                                    <input type="text" id="newLastName" data-translate-key="um.modal.last_name" placeholder="Apellido" maxlength="50" autocomplete="off" />
                                </div>
                                <div class="field-group">
                                    <div class="um-phones-header">
                                        <label data-translate-key="um.modal.phone">Teléfonos</label>
                                        <button type="button" class="um-phone-add-btn" onclick="addPhoneRow('newPhoneList')">
                                            <span class="material-icons">add</span><span data-translate-key="um.modal.add_phone"> Agregar</span>
                                        </button>
                                    </div>
                                    <div id="newPhoneList" class="um-phone-list"></div>
                                </div>
                                <div class="field-group">
                        ...
                        <div id="editModeFields" style="display:none">
                            <div class="um-general-grid">
                                <div class="field-group">
                                    ...
                                    <input type="text" id="editFirstName" data-translate-key="um.modal.first_name" placeholder="Nombre" maxlength="50" autocomplete="off" />
                                </div>
                                <div class="field-group">
                                    <label for="editLastName" data-translate-key="um.modal.last_name">Apellido</label>
                                    <input type="text" id="editLastName" data-translate-key="um.modal.last_name" placeholder="Apellido" maxlength="50" autocomplete="off" />
                                </div>
                                <div class="field-group">
                                    <div class="um-phones-header">
                                        <label data-translate-key="um.modal.phone">Teléfonos</label>
                                        <button type="button" class="um-phone-add-btn" onclick="addPhoneRow('editPhoneList')">
                                            <span class="material-icons">add</span><span data-translate-key="um.modal.add_phone"> Agregar</span>
                                        </button>
                                    </div>
                                    <div id="editPhoneList" class="um-phone-list"></div>
                                </div>
                                <div class="field-group">
                        ...
                        <div class="um-loc-meta-row">
                            ...
                            <div class="um-loc-bulk">
                                <button type="button" class="um-loc-bulk-btn" onclick="toggleAllLocations(true)">
                                    <span class="material-icons">check_box</span><span data-translate-key="um.loc.all">Todos</span>
                                </button>
                                <button type="button" class="um-loc-bulk-btn" onclick="toggleAllLocations(false)">
                                    <span class="material-icons">check_box_outline_blank</span><span data-translate-key="um.loc.none">Ninguno</span>
                                </button>
                                <button type="button" class="um-loc-bulk-btn um-loc-restore-btn" id="btnRestoreLocs"
                                        onclick="restoreLocations()" style="display:none;">
                                    <span class="material-icons">restore</span><span data-translate-key="um.loc.restore">Restaurar</span>
                                </button>
                            </div>
                        </div>
