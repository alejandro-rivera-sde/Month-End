    ...
    public partial class WarehouseManagement : SecurePage {
        ...
        private void LoadStats() {
            try {
                ...
                AppLogger.Error("WarehouseManagement.LoadStats", ex);
            }
        }
        ...
        private void LoadLocations() {
            try {
                ...
                AppLogger.Error("WarehouseManagement.LoadLocations", ex);
            }
        }
        ...
        public static object GetLocationDetail(int locationId) {
            try {
                ...
                AppLogger.Error("WarehouseManagement.GetLocationDetail", ex);
                ...
                using (SqlConnection conn = new SqlConnection(_connStr)) {
                    ...
                    using (SqlTransaction tx = conn.BeginTransaction()) {
                        try {
                            ...
                            tx.Rollback();
                            AppLogger.Error("WarehouseManagement.SaveLocation tx", inner);
                            return new { Success = false, Message = inner.Message };
                        }
                    }
                }
            } catch (Exception ex) {
                AppLogger.Error("WarehouseManagement.SaveLocation", ex);
                return new { Success = false, Message = ex.Message };
            }
        }
        ...
        public static object ToggleLocationActive(int locationId, bool active) {
            try {
                ...
                AppLogger.Error("WarehouseManagement.ToggleLocationActive", ex);
                return new { Success = false, Message = ex.Message };
            }
        }
    }
