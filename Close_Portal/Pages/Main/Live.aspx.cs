    ...
    public partial class Dashboard : SecurePage {
        ...
        public static object GetDashboardData() {
            ...
            try {
                ...
                AppLogger.Error("Live.GetDashboardData", ex);
        ...
        public static object TryCloseGuard() {
            ...
            try {
                using (var conn = new SqlConnection(cs)) {
                    ...
                    Hubs.LocationHub.NotifyGuardClosed(guardId);

                    return new { success = true, closed = true };
                }
            } catch (Exception ex) {
                AppLogger.Error("Live.TryCloseGuard", ex);
        ...
        public static object GetGuardSpots() {
            try {
                ...
                AppLogger.Error("Live.GetGuardSpots", ex);
            ...
            try {
                ...
                using (var cmd = new SqlCommand(@"
                    ...
                    DECLARE @GuardStart DATETIME = (
                        SELECT Created_At FROM MonthEnd_Guard_Schedule
                        WHERE Guard_Id = @ActiveGuardId
                    )
                    SELECT COUNT(*) FROM MonthEnd_Notifications
                    WHERE User_Id  = @UserId
                      AND Is_Read  = 0
                      AND @ActiveGuardId IS NOT NULL
                      AND Created_At >= @GuardStart", conn)) {
                ...
                AppLogger.Error("Live.GetUnreadCount", ex);
        ...
        public static object GetNotifications() {
            try {
                ...
                AppLogger.Error("Live.GetNotifications", ex);
                return new { success = false };
            }
        }
        ...
        public static object MarkAsRead(int referenceId, string type) {
            try {
                ...
                AppLogger.Error("Live.MarkAsRead", ex);
                return new { success = false };
            }
        }
        ...
        public static object MarkAllRead() {
            try {
                ...
                AppLogger.Error("Live.MarkAllRead", ex);
                return new { success = false };
            }
        }
        ...
        public static object GetMyPhones() {
            try {
                ...
                AppLogger.Error("Live.GetMyPhones", ex);
                return new { success = false };
            }
        }
                ...
                using (var conn = new SqlConnection(cs)) {
                    ...
                    using (var tx = conn.BeginTransaction()) {
                        try {
                            ...
                            tx.Rollback();
                            AppLogger.Error("Live.SaveMyPhones tx", ex);
                            return new { success = false, message = "Error al guardar" };
                        }
                    }
                }
            } catch (Exception ex) {
                AppLogger.Error("Live.SaveMyPhones", ex);
