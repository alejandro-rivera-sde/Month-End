...
<asp:Content ID="DashboardContent" ContentPlaceHolderID="DashboardContent" runat="server">
    ...
    <div class="page-header">
        <div class="page-title">
            ...
            <p>Administración de notificaciones, grupos de correo y alertas del sistema</p>
        </div>
        <div class="es-header-badge" id="esStatusBadge">
            <span class="material-icons">circle</span>
            <span id="esStatusText">Cargando...</span>
        </div>
    </div>
        ...
        <div class="es-controls-grid">
            ...
            <div class="es-control-card" id="esMainCard">
                <div class="es-control-info">
                    <div class="es-control-title">Notificaciones globales</div>
                    <div class="es-control-desc">Activa o desactiva el envío de todos los correos del sistema.</div>
                    <div class="es-control-warning">
                        <span class="material-icons">info</span>
                        El estado se reinicia al reiniciar el servidor.
                    </div>
                </div>
                <label class="es-toggle" id="esMainToggleLabel">
                    ...
                    <span class="es-toggle-label" id="esMainToggleText">Desactivado</span>
                </label>
            </div>
            ...
            <div class="es-control-card" id="esTestCard">
                <div class="es-control-info">
                    <div class="es-control-title">Modo prueba</div>
                    <div class="es-control-desc">Redirige todos los correos a un único destinatario de prueba, ignorando los grupos reales.</div>
                </div>
                <div class="es-test-row">
                    <label class="es-toggle">
                        ...
                        <span class="es-toggle-label" id="esTestToggleText">Desactivado</span>
                    </label>
    ...
    <div class="es-section">
        <div class="es-section-header">
            ...
            <h3>Grupos de correo</h3>
        </div>
        <p class="es-section-desc">Grupos configurados en el servidor. Para modificarlos, actualiza los AppSettings en el servidor.</p>
        ...
        <div class="es-section-header">
            ...
            <div class="es-alert-bulk">
                <button type="button" class="es-btn-sm" onclick="setBulkAlerts(true)">
                    <span class="material-icons">done_all</span> Activar todas
                </button>
                <button type="button" class="es-btn-sm es-btn-sm-muted" onclick="setBulkAlerts(false)">
                    <span class="material-icons">remove_done</span> Desactivar todas
                </button>
            </div>
        </div>
