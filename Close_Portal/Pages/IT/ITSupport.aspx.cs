...
namespace Close_Portal.Pages.IT {
    ...
    public partial class ITSupportPage : SecurePage {
        ...
        protected void Page_Load(object sender, EventArgs e) {
            ...
            string deptCode = new GuardDataAccess().GetUserDepartmentCode(CurrentUserId);
            if (!string.Equals(deptCode, "IT", StringComparison.OrdinalIgnoreCase))
                Response.Redirect("~/Pages/Home/Error.aspx?reason=unauthorized", true);
        }
        ...
        private static bool TryGetAgent(out int userId) {
            ...
            if (roleId < RoleLevel.Administrador) return false;
            string deptCode = new DataAccess.GuardDataAccess().GetUserDepartmentCode(userId);
            return string.Equals(deptCode, "IT", StringComparison.OrdinalIgnoreCase);
        }
        ...
        public static object GetCases() {
            try {
                ...
                AppLogger.Error("ITSupport.GetCases", ex);
        ...
        public static object GetHistorial(int clientId) {
            try {
                ...
                AppLogger.Error("ITSupport.GetHistorial", ex);
                return new { success = false, message = ex.Message };
            }
        }
    }
