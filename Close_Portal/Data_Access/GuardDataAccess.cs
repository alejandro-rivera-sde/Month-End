    ...
    public class GuardDataAccess {
        ...
        public List<DepartmentViewModel> GetDepartments() {
            ...
            try {
                ...
                AppLogger.Error("GetDepartments", ex);
            }
            return list;
        }
        ...
        public int GetUserDepartmentId(int userId) {
            try {
                ...
                AppLogger.Error("GetUserDepartmentId", ex);
                return -1;
            }
        }
        ...
        public string GetUserDepartmentCode(int userId) {
            try {
                ...
                AppLogger.Error("GetUserDepartmentCode", ex);
                return null;
            }
        }
        ...
        public int GetSpotDepartmentId(int spotId) {
            try {
                ...
                AppLogger.Error("GetSpotDepartmentId", ex);
                return -1;
            }
        }
        ...
        public int GetSpotGuardId(int spotId) {
            try {
                ...
                AppLogger.Error("GetSpotGuardId", ex);
                return 0;
            }
        }
        ...
        public List<GuardUserViewModel> GetUsersByDepartment(int departmentId) {
            ...
            try {
                ...
                AppLogger.Error("GetUsersByDepartment", ex);
            }
            return list;
        }
        ...
        public GuardViewModel GetCurrentGuard() {
            try {
                ...
                AppLogger.Error("GetCurrentGuard", ex);
                return null;
            }
        }
        ...
        public List<GuardViewModel> GetGuardHistory(int top = 20) {
            ...
            try {
                ...
                AppLogger.Error("GetGuardHistory", ex);
            }
            return list;
        }
        ...
        public GuardResult ReserveDates(int createdBy, DateTime startTime, DateTime? estimatedEndTime = null) {
            try {
                ...
                AppLogger.Error("ReserveDates", ex);
        ...
        public GuardResult SaveGuardLocations(int guardId, List<int> locationIds) {
            ...
            try {
                ...
                AppLogger.Error("SaveGuardLocations", ex);
                return new GuardResult { Success = false, Message = ex.Message };
            }
        }
        ...
        public GuardResult ConfirmGuard(int guardId) {
            try {
                ...
                AppLogger.Error("ConfirmGuard", ex);
                return new GuardResult { Success = false, Message = ex.Message };
            }
        }
        ...
        public GuardResult UnassignSpot(int spotId) {
            try {
                ...
                AppLogger.Error("UnassignSpot", ex);
                return new GuardResult { Success = false, Message = ex.Message };
            }
        }
        ...
        public GuardResult CloseGuard(int guardId) {
            try {
                ...
                AppLogger.Error("CloseGuard", ex);
                return new GuardResult { Success = false, Message = ex.Message };
            }
        }

        // ────────────────────────────────────────────────────────────────
        // GET GUARD START TIME — devuelve el Start_Time de una guardia por ID
        // ────────────────────────────────────────────────────────────────
        public DateTime? GetGuardStartTime(int guardId) {
            try {
                using (var conn = new SqlConnection(_connStr))
                using (var cmd = new SqlCommand(
                    "SELECT Start_Time FROM MonthEnd_Guard_Schedule WHERE Guard_Id = @GuardId", conn)) {
                    cmd.Parameters.AddWithValue("@GuardId", guardId);
                    conn.Open();
                    var val = cmd.ExecuteScalar();
                    return val != null && val != DBNull.Value ? (DateTime?)val : null;
                }
            } catch (Exception ex) {
                AppLogger.Error("GetGuardStartTime", ex);
                return null;
            }
        }
        ...
        public GuardResult RemoveGuard(int guardId) {
            try {
                ...
                AppLogger.Error("RemoveGuard", ex);
                return new GuardResult { Success = false, Message = ex.Message };
            }
        }
        ...
        public List<ActiveLocationViewModel> GetAllActiveLocations() {
            ...
            try {
                ...
                AppLogger.Error("GetAllActiveLocations", ex);
            }
            return list;
        }
        ...
        public List<GuardLocationViewModel> GetActiveGuardLocations() {
            ...
            try {
                ...
                AppLogger.Error("GetActiveGuardLocations", ex);
            }
            return list;
        }
        ...
        public static string GetActiveGuardEmails() {
            try {
                ...
                AppLogger.Error("GetActiveGuardEmails", ex);
                return null;
            }
        }

        // ────────────────────────────────────────────────────────────────
        // GET NEXT PENDING AUTO-ASSIGN TIME
        // Devuelve el Start_Time más próximo (futuro) de una guardia confirmada
        // que tenga spots vacíos con Default_User_Id configurado.
        // Usado por Startup para programar el timer preciso.
        // ────────────────────────────────────────────────────────────────
        public static DateTime? GetNextPendingAutoAssignTime() {
            try {
                const string sql = @"
                    SELECT MIN(gs.Start_Time)
                    FROM MonthEnd_Guard_Schedule gs
                ...
                using (var cmd = new SqlCommand(sql, conn)) {
                    conn.Open();
                    var val = cmd.ExecuteScalar();
                    return (val == null || val == DBNull.Value) ? (DateTime?)null : (DateTime)val;
                }
            } catch (Exception ex) {
                AppLogger.Error("GuardDataAccess.GetNextPendingAutoAssignTime", ex);
                return null;
            }
        }
            ...
            try {
                ...
                foreach (var (spotId, guardId, deptCode, defaultUserId) in toAssign) {
                    try {
                        ...
                        AppLogger.Error($"GuardDataAccess.AutoAssignDefaultSpots spot {spotId}", ex);
                    }
                }
            } catch (Exception ex) {
                AppLogger.Error("AutoAssignDefaultSpots", ex);
            }
