    ...
    public class ChatDataAccess {
        ...
        public int GetActiveGuardId() {
            try {
                ...
                System.Diagnostics.Debug.WriteLine($"[ChatDataAccess.GetActiveGuardId] ERROR: {ex.Message}");
                return 0;
            }
        }
        ...
        public int GetOrCreateCase(int clientId, int guardId) {
            try {
                ...
                System.Diagnostics.Debug.WriteLine($"[ChatDataAccess.GetOrCreateCase] ERROR: {ex.Message}");
                return 0;
            }
        }
        ...
        public int GetCaseIdForClient(int clientId, int guardId) {
            try {
                ...
                System.Diagnostics.Debug.WriteLine($"[ChatDataAccess.GetCaseIdForClient] ERROR: {ex.Message}");
                return 0;
            }
        }
        ...
        public List<SupportCaseViewModel> GetActiveCases() {
            ...
            try {
                ...
                System.Diagnostics.Debug.WriteLine($"[ChatDataAccess.GetActiveCases] ERROR: {ex.Message}");
            }
            return result;
        }
    }
